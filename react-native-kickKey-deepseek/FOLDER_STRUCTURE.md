...
├── CLAUDE.md
├── knowledge.md              # Freebuff reads this at the root — keep here
│
...
→ `docs/`. Keep `ReadMe.md`, `LICENSE`, `AGENTS.md`, `CLAUDE.md`, `knowledge.md`
...
- plus the path mentions in `knowledge.md` / `ReadMe.md`.
...
| `ReadMe.md`, `LICENSE`, `AGENTS.md`, `CLAUDE.md`, `knowledge.md` | Root conventions for GitHub and coding agents. |
...
# 8. Update the structure section in knowledge.md
```
